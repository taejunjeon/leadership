...
from app.schemas.survey import DimensionType
...
def create_valid_survey_response():
    ...
    question_id = 0
    for dim_idx, (dimension, count) in enumerate(zip(dimensions, questions_per_dimension)):
        ...
        with patch("app.middleware.auth.auth_middleware.get_current_user") as mock_auth:
            ...
            with patch("app.core.supabase.supabase_service.table") as mock_table:
                ...
                with patch("hashlib.sha256") as mock_hash:
                    ...
                    assert any("24시간 내 동일한 응답" in error for error in data["errors"])
