...
from app.schemas.survey import SurveyResponseDB, DimensionType
from app.core.config import settings
from app.middleware.rate_limit import rate_limiter, usage_monitor
from app.utils.anomaly import anomaly_detector
...
"""
        ...
        try:
            ...
            completion = await asyncio.wait_for(
                self.client.chat.completions.create(
                    model=self.model,
                    messages=[
                        {"role": "system", "content": "You are an expert leadership coach."},
    ...
    async def analyze_response_pattern(
        ...
        try:
            ...
            return {
                ...
                "recommendation": self._get_reliability_recommendation(reliability_score)
            }
    ...
    def _parse_llm_response(self, content: str) -> Dict[str, Any]:
        ...
        for line in lines:
            ...
            if "analysis" in line.lower() or line.startswith("1."):
                ...
                elif current_section in ["strengths", "growth_areas", "recommendations"]:
                    if clean_line:
    ...
    def _summarize_response_pattern(self, responses: List[Dict[str, Any]]) -> Dict[str, Any]:
        """응답 패턴 요약"""
        ...
        return {
            ...
            "value_distribution": {
                f"value_{i}": values.count(i) for i in range(1, 8)
            },
            "dimension_averages": {
