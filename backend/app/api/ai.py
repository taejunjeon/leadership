...
from ..schemas.ai import AIAnalysisRequest, AIInsightResponse, AIProviderInfo
...
async def analyze_with_ai(request: AIAnalysisRequest):
    ...
    try:
        ...
        await trigger_analysis(
            request.user_id, responses, ai_provider=request.ai_provider
        )
        ...
        return AIInsightResponse(
            ...
            expected_outcomes=ai_insights.get("ai_insights", {}).get(
                "expected_outcomes", ""
            ),
            ...
            try:
                ...
                if analysis_result.data:
                    data = {
                        ...
                        "production": analysis_result.data[0][
                            "blake_mouton_production"
                        ],
