...
async def test_imports():
    ...
    try:
        ...
        from app.api import health, auth, survey, analysis, reports
...
async def test_analysis_engine():
    ...
    try:
        ...
        # 샘플 응답 데이터
        sample_responses = {
            "bm_1": 5, "bm_2": 6, "bm_3": 4, "bm_4": 7,
            "bm_5": 5, "bm_6": 6, "bm_7": 4, "bm_8": 7,
            "bm_9": 5, "bm_10": 6, "bm_11": 4, "bm_12": 7,
            "bm_13": 5, "bm_14": 6,
            "rc_1": 6, "rc_2": 5, "rc_3": 6, "rc_4": 5,
            "rc_5": 6, "rc_6": 5, "rc_7": 6, "rc_8": 5,
            "rc_9": 6, "rc_10": 5,
            "lmx_1": 5, "lmx_2": 5, "lmx_3": 5, "lmx_4": 5,
            "lmx_5": 5, "lmx_6": 5, "lmx_7": 5, "lmx_8": 5,
            "lmx_9": 5, "lmx_10": 5,
            "ig_1": 3, "ig_2": 3, "ig_3": 3,
            "ig_4": 3, "ig_5": 3, "ig_6": 3,
            "ig_7": 3, "ig_8": 3, "ig_9": 3
        }
        ...
        print(f"✅ Dimensions calculated: People={dimensions.people}, Production={dimensions.production}")
        
        # 스타일 분류
        style = analyzer.classify_leadership_style(dimensions.people, dimensions.production)
